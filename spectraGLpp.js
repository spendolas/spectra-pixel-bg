/*
 * Field controls (pixel mode): field{octaves,lacunarity,gain,amplitude,warpStrength,seed,flow,angle,noiseType,fractalType,boxFreq,debug}
 * Top-level fieldOctaves/fieldLacunarity/... are supported; nested field wins.
 */
!function() {
    "use strict";
    const e = {
        ...
        detect() {
            ...
            try {
                e.getContext("webgl2") && (this.webgl2 = !0,
                this.webgl1 = !0)
            } catch (e) {}
            if (!this.webgl2)
                try {
                    (e.getContext("webgl") || e.getContext("experimental-webgl")) && (this.webgl1 = !0)
                } catch (e) {}
            this.detected = !0
        },
        getSupported() {
            return this.detect(),
            this.webgl2 ? "webgl2" : !!this.webgl1 && "webgl"
        }
    };
    let n = null
      , o = 0
    ...
    function normalizeVec2(e, n) {
        if (Array.isArray(e) && e.length >= 2)
            return [Number(e[0]) || 0, Number(e[1]) || 0];
        if (e && "object" == typeof e && "x"in e && "y"in e)
            return [Number(e.x) || 0, Number(e.y) || 0];
        if ("number" == typeof e && !isNaN(e))
            return [e, e];
        return n
    }
    function normalizeFieldOptions(e, n) {
        const o = e || {}
          , t = o.field || {}
          , i = {
            octaves: o.fieldOctaves,
            lacunarity: o.fieldLacunarity,
            gain: o.fieldGain,
            amplitude: o.fieldAmplitude,
            warpStrength: o.fieldWarpStrength,
            seed: o.fieldSeed,
            flow: o.fieldFlow,
            angle: o.fieldAngle,
            noiseType: o.fieldNoiseType,
            fractalType: o.fieldFractalType,
            boxFreq: o.fieldBoxFreq,
            debug: o.fieldDebug
        }
          , l = {
            ...n
          ...
          , s = e => "string" == typeof e && e.length;
        a(i.octaves) && (l.octaves = Math.max(1, Math.min(8, Math.round(i.octaves)))),
        a(i.lacunarity) && (l.lacunarity = i.lacunarity),
        a(i.gain) && (l.gain = i.gain),
        a(i.amplitude) && (l.amplitude = i.amplitude),
        a(i.warpStrength) && (l.warpStrength = i.warpStrength),
        void 0 !== i.seed && (l.seed = normalizeVec2(i.seed, l.seed)),
        void 0 !== i.flow && (l.flow = normalizeVec2(i.flow, l.flow)),
        a(i.angle) && (l.angle = i.angle),
        (s(i.noiseType) || a(i.noiseType)) && (l.noiseType = i.noiseType),
        (s(i.fractalType) || a(i.fractalType)) && (l.fractalType = i.fractalType),
        a(i.boxFreq) && (l.boxFreq = i.boxFreq),
        a(i.min) && (l.min = i.min),
        a(i.max) && (l.max = i.max),
        a(i.debug) && (l.debug = Math.max(0, Math.min(4, Math.round(i.debug)))),
        a(t.octaves) && (l.octaves = Math.max(1, Math.min(8, Math.round(t.octaves)))),
        a(t.lacunarity) && (l.lacunarity = t.lacunarity),
        a(t.gain) && (l.gain = t.gain),
        a(t.amplitude) && (l.amplitude = t.amplitude),
        a(t.warpStrength) && (l.warpStrength = t.warpStrength),
        void 0 !== t.seed && (l.seed = normalizeVec2(t.seed, l.seed)),
        void 0 !== t.flow && (l.flow = normalizeVec2(t.flow, l.flow)),
        a(t.angle) && (l.angle = t.angle),
        (s(t.noiseType) || a(t.noiseType)) && (l.noiseType = t.noiseType),
        (s(t.fractalType) || a(t.fractalType)) && (l.fractalType = t.fractalType),
        a(t.boxFreq) && (l.boxFreq = t.boxFreq),
        a(t.min) && (l.min = t.min),
        a(t.max) && (l.max = t.max),
        a(t.debug) && (l.debug = Math.max(0, Math.min(4, Math.round(t.debug))));
        return l
    }
    function fieldNoiseTypeToInt(e) {
        const n = {
            value: 0,
            simplex: 1,
            worley: 2,
        ...
        return "number" == typeof e && !isNaN(e) ? Math.max(0, Math.min(3, Math.round(e))) : n[e] ?? 0
    }
    function fieldFractalTypeToInt(e) {
        const n = {
            none: 0,
            fbm: 1,
            turbulence: 2,
        ...
        return "number" == typeof e && !isNaN(e) ? Math.max(0, Math.min(3, Math.round(e))) : n[e] ?? 1
    }
    const p = "\n    vec3 mod289(vec3 x) { return x - floor(x * (1.0 / 289.0)) * 289.0; }\n    vec2 mod289(vec2 x) { return x - floor(x * (1.0 / 289.0)) * 289.0; }\n    vec3 permute(vec3 x) { return mod289(((x*34.0)+1.0)*x); }\n\n    float snoise(vec2 v) {\n      const vec4 C = vec4(0.211324865405187, 0.366025403784439,\n                         -0.577350269189626, 0.024390243902439);\n      vec2 i  = floor(v + dot(v, C.yy));\n      vec2 x0 = v - i + dot(i, C.xx);\n      vec2 i1 = (x0.x > x0.y) ? vec2(1.0, 0.0) : vec2(0.0, 1.0);\n      vec4 x12 = x0.xyxy + C.xxzz;\n      x12.xy -= i1;\n      i = mod289(i);\n      vec3 p = permute(permute(i.y + vec3(0.0, i1.y, 1.0)) + i.x + vec3(0.0, i1.x, 1.0));\n      vec3 m = max(0.5 - vec3(dot(x0,x0), dot(x12.xy,x12.xy), dot(x12.zw,x12.zw)), 0.0);\n      m = m*m; m = m*m;\n      vec3 x = 2.0 * fract(p * C.www) - 1.0;\n      vec3 h = abs(x) - 0.5;\n      vec3 ox = floor(x + 0.5);\n      vec3 a0 = x - ox;\n      m *= 1.79284291400159 - 0.85373472095314 * (a0*a0 + h*h);\n      vec3 g;\n      g.x = a0.x * x0.x + h.x * x0.y;\n      g.yz = a0.yz * x12.xz + h.yz * x12.yw;\n      return 130.0 * dot(m, g);\n    }\n\n    float fbm(vec2 p, int octaves) {\n      float value = 0.0;\n      float amplitude = 0.5;\n      float frequency = 1.0;\n      for (int i = 0; i < 6; i++) {\n        if (i >= octaves) break;\n        value += amplitude * snoise(p * frequency);\n        frequency *= 2.0;\n        amplitude *= 0.5;\n      }\n      return value;\n    }\n  "
      ...
      , x = new Set(["h1", "h2", "h3", "h4", "h5", "h6", "p", "span", "a", "label", "button", "strong", "b", "em", "i", "u", "s", "strike", "del", "ins", "mark", "small", "sub", "sup", "code", "kbd", "samp", "var", "cite", "dfn", "abbr", "q", "time", "data", "blockquote", "pre", "address", "figcaption", "li", "dt", "dd", "th", "td", "caption", "legend", "option", "summary", "bdi", "bdo", "ruby", "rt", "rp", "wbr"]);
    class b {
        constructor() {
            ...
            this.targetMouse = new THREE.Vector2(.5,.5),
        ...
        initSharedRenderer() {
            ...
            let i;
            return i = "webgl2" === n ? o.getContext("webgl2", t) : o.getContext("webgl", t) || o.getContext("experimental-webgl", t),
            !!i && (this.sharedRenderer = new THREE.WebGLRenderer({
                canvas: o,
                context: i,
                antialias: !v(),
                alpha: !0,
            ...
            this.sharedRenderer.setClearColor(0, 0),
            this.sharedRenderer.autoClear = !0,
            !0)
        }
        createMesh(e) {
            const n = g[e.mode];
            if (!n)
                return console.error(`spectraGL: Unknown mode "${e.mode}"`),
                null;
            let o = Math.min(e.meshDetail, 128);
            if (v()) {
                ["nebula", "oil", "floral"].includes(e.mode) && (o = Math.max(8, Math.floor(.5 * o)))
            }
            const t = new THREE.PlaneGeometry(2,2,o,o)
              , i = [...e.colors]
              , l = e.field || {};
            for (; i.length < 7; )
                i.push(i[i.length - 1] || "#ffffff");
            const a = e.colorBalance || []
              , s = [];
            for (let e = 0; e < 7; e++)
                s.push(void 0 !== a[e] ? a[e] : 1);
            const r = {
                smooth: 0,
                sharp: 1,
                stepped: 2
              ...
              , u = new THREE.ShaderMaterial({
                uniforms: {
                    ...
                    uColors: {
                        value: i.slice(0, 7).map(e => new THREE.Color(e))
                    },
                    uColorBlend: {
                        value: r
                    },
                    ...
                    uFieldWarpStrength: {
                        value: l.warpStrength
                    },
                    uFieldSeed: {
                        value: new THREE.Vector2(l.seed[0], l.seed[1])
                    },
                    uFieldFlow: {
                        value: new THREE.Vector2(l.flow[0], l.flow[1])
                    },
                    uFieldAngle: {
                        value: l.angle
                    },
                    uFieldNoiseType: {
                        value: fieldNoiseTypeToInt(l.noiseType)
                    },
                    uFieldFractalType: {
                        value: fieldFractalTypeToInt(l.fractalType)
                    },
                    uFieldBoxFreq: {
                        value: l.boxFreq
                    },
                    ...
                    uRimLight: {
                        value: e.rimLight ? 1 : 0
                    },
                    uRimIntensity: {
                        value: e.rimIntensity
                    },
                    uRimColor: {
                        value: new THREE.Color(e.rimColor)
                    },
                    uRimFalloff: {
                        value: e.rimFalloff
                    },
                    ...
                    uReactiveStrength: {
                        value: e.reactive ? e.reactiveStrength : 0
                    },
                    uMouseRadius: {
                        value: e.mouseRadius
                    },
                ...
                fragmentShader: n.fragment,
                transparent: !0,
                side: THREE.DoubleSide
            });
            return new THREE.Mesh(t,u)
        }
        addEffect(e, n, o) {
            if (!this.sharedRenderer)
                return this.applyFallback(n, o),
                !1;
            const t = function(e) {
                const n = e.tagName.toLowerCase();
                return x.has(n)
            }(n) && !o.border?.enabled;
            t && (o._isTextElement = !0);
            const i = this.createMesh(o);
            if (!i)
                return !1;
            const l = new THREE.Scene
              , a = new THREE.OrthographicCamera(-1,1,1,-1,-100,100);
            a.position.z = 10,
            l.add(i);
            const s = function(e) {
                let n = 0
                ...
                for (; t && t !== document.body; ) {
                    const e = window.getComputedStyle(t)
                      , i = e.position
                      , l = parseInt(e.zIndex, 10);
                    "fixed" === i && (o = !0),
                    "static" === i || isNaN(l) || (n = Math.max(n, l)),
                    t = t.parentElement
                }
                const i = window.getComputedStyle(e)
                  , l = parseInt(i.zIndex, 10);
                "static" === i.position || isNaN(l) || (n = Math.max(n, l));
                return {
            ...
            r.setAttribute("data-spectra-id", e);
            const c = r.getContext("2d", {
                alpha: !0
            });
            if (s.isFixedContext ? document.body.appendChild(r) : n.parentNode.insertBefore(r, n),
            this.displayCanvases.set(e, {
                canvas: r,
                ctx: c,
                lastWidth: 0,
                lastHeight: 0
            ...
            this.effects.set(e, {
                ...
                inView: !0,
                observer: null,
                originalVisibility: n.style.visibility,
                currentMouse: new THREE.Vector2(.5,.5),
                prevMouse: new THREE.Vector2(.5,.5),
                mouseVelocity: new THREE.Vector2(0,0),
                displacement: new THREE.Vector2(0,0),
                pulse: 0,
                clickOffset: 0,
                clickOffsetTarget: 0,
                lastClickPos: new THREE.Vector2(.5,.5),
                scrollOffset: 0,
                scrollVelocity: 0,
                stacking: s,
                useTextMask: t
            }),
            t && this.updateTextMask(e, n, i),
            this.targetElements.set(e, n),
            "IntersectionObserver"in window) {
                const o = new IntersectionObserver(n => {
                    const o = this.effects.get(e);
                    o && (o.inView = n[0].isIntersecting)
                }
                ,{
                    root: null,
                    threshold: 0,
                ...
                o.observe(n),
                this.effects.get(e).observer = o
            }
            if (!o.border || !o.border.enabled)
                if (t)
                    setTimeout( () => {
                    ...
                    if (e && e !== document.body) {
                        ...
                        "isolate" === n.isolation || "auto" !== n.zIndex || o || t || "1" !== n.opacity || (e.style.isolation = "isolate")
                    }
                    setTimeout( () => {
        ...
        updateTextMask(e, n, o) {
            const t = n.getBoundingClientRect();
            if (t.width <= 0 || t.height <= 0) {
                const n = this.effects.get(e);
                return void (n && (n.needsTextMask = !0))
            }
            const i = function(e, n, o) {
                const t = document.createElement("canvas")
                  , i = t.getContext("2d")
                  , l = Math.min(window.devicePixelRatio, 2);
                t.width = n * l,
                t.height = o * l,
                ...
                return g = isNaN(x) ? m * l : (x - s) / 2 * l + m * l,
                i.fillText(p, h, g),
                t
            }(n, t.width, t.height)
              , l = new THREE.CanvasTexture(i);
            l.needsUpdate = !0,
            l.minFilter = THREE.LinearFilter,
            l.magFilter = THREE.LinearFilter,
            l.format = THREE.RGBAFormat,
            l.premultiplyAlpha = !1;
            const a = this.textMasks.get(e);
            a && a.dispose(),
            this.textMasks.set(e, l),
            o && o.material && o.material.uniforms && (o.material.uniforms.uTextMask.value = l,
            o.material.uniforms.uUseTextMask.value = 1,
            o.material.needsUpdate = !0)
        }
        applyFallback(e, n) {
            const o = `linear-gradient(135deg, ${n.colors.slice(0, 3).join(", ")})`;
            e.style.background = o,
            e.setAttribute("data-spectra-fallback", "true")
        }
        removeEffect(e, n=!1) {
            const o = this.effects.get(e);
            if (o) {
                n || (o.element.style.visibility = o.originalVisibility || "");
                const t = this.displayCanvases.get(e);
                t && t.canvas && t.canvas.remove(),
                this.displayCanvases.delete(e),
                o.mesh && (o.mesh.geometry && o.mesh.geometry.dispose(),
                o.mesh.material && o.mesh.material.dispose());
                const i = this.textMasks.get(e);
                i && (i.dispose(),
                this.textMasks.delete(e)),
                o.observer && o.observer.disconnect(),
                this.effects.delete(e),
                this.targetElements.delete(e)
            }
        }
        onMouseMove(e) {
            for (const [n,o] of this.effects) {
                if (!o.options.reactive)
                    continue;
                const n = o.element.getBoundingClientRect();
                if (e.clientX >= n.left && e.clientX <= n.right && e.clientY >= n.top && e.clientY <= n.bottom) {
                    const t = (e.clientX - n.left) / n.width
                      , i = 1 - (e.clientY - n.top) / n.height;
                    o.currentMouse.set(t, i)
                }
            }
        }
        onMouseDown(e) {
            for (const [n,o] of this.effects) {
                const n = o.element.getBoundingClientRect();
                if (e.clientX >= n.left && e.clientX <= n.right && e.clientY >= n.top && e.clientY <= n.bottom && o.options.reactive) {
                    o.pulse = 1;
                    const t = (e.clientX - n.left) / n.width
                      , i = 1 - (e.clientY - n.top) / n.height;
                    o.lastClickPos = new THREE.Vector2(t,i),
                    "aurora" === o.options.mode && (o.clickOffsetTarget = (o.clickOffsetTarget || 0) + .6)
                }
            }
        }
        onTouchStart(e) {
            if (e.touches.length > 0) {
                const n = e.touches[0];
                for (const [e,o] of this.effects) {
                    const e = o.element.getBoundingClientRect();
                    if (n.clientX >= e.left && n.clientX <= e.right && n.clientY >= e.top && n.clientY <= e.bottom && (o.lastTouchY = n.clientY,
                    o.options.reactive)) {
                        const t = (n.clientX - e.left) / e.width
                          , i = 1 - (n.clientY - e.top) / e.height;
                        o.currentMouse.set(t, i),
                        o.pulse = 1,
                        "aurora" === o.options.mode && (o.clickOffsetTarget = (o.clickOffsetTarget || 0) + .6,
                        o.lastClickPos = new THREE.Vector2(t,i))
            ...
            if (e.touches.length > 0) {
                ...
                for (const [e,o] of this.effects) {
                    ...
                    if (n.clientX >= e.left && n.clientX <= e.right && n.clientY >= e.top && n.clientY <= e.bottom) {
                        if (o.options.scrollReactive && void 0 !== o.lastTouchY) {
                            const e = o.lastTouchY - n.clientY
                              , t = o.options.scrollStrength || .2;
                            o.scrollVelocity -= .003 * e * t,
                            o.lastTouchY = n.clientY
                        }
                        if (o.options.reactive) {
                            const t = (n.clientX - e.left) / e.width
                              , i = 1 - (n.clientY - e.top) / e.height;
        ...
        onWheel(e) {
            for (const [n,o] of this.effects) {
                if (!o.options.scrollReactive)
                    continue;
                const n = o.element.getBoundingClientRect();
                if (e.clientX >= n.left && e.clientX <= n.right && e.clientY >= n.top && e.clientY <= n.bottom) {
                    const n = o.options.scrollStrength || .2;
                    o.scrollVelocity -= 8e-4 * e.deltaY * n
                }
            }
        }
        onVisibilityChange() {
        ...
        animate() {
            if (!l)
                return;
            if (!this.sharedRenderer)
                return void (i = requestAnimationFrame( () => this.animate()));
            if (!u)
                return void (i = requestAnimationFrame( () => this.animate()));
            ...
            if (n < c)
                ...
                r = e - n % c,
                this.time += Math.min(n / 1e3, .1);
                for (const [n,o] of this.effects) {
                    if (!o.inView)
                        continue;
                    const {mesh: t, scene: i, camera: l, options: a, element: s} = o
                      , r = this.displayCanvases.get(n);
                    if (!r)
                        continue;
                    const {canvas: c, ctx: u} = r;
                    (!o.cachedRect || o.rectCacheTime < e - 100) && (o.cachedRect = s.getBoundingClientRect(),
                    o.rectCacheTime = e);
                    const f = o.cachedRect;
                    if (f.width <= 1 || f.height <= 1)
                        continue;
                    o.needsTextMask && o.useTextMask && (this.updateTextMask(n, s, t),
                    o.needsTextMask = !1);
                    const d = o.currentMouse.x - o.prevMouse.x
                      , m = o.currentMouse.y - o.prevMouse.y;
                    if (o.mouseVelocity.set(d, m),
                    o.prevMouse.copy(o.currentMouse),
                    a.reactive) {
                        const e = 26.67 * (void 0 !== a.displacementStrength ? a.displacementStrength : .3);
                        o.displacement.x += d * e,
                        o.displacement.y += m * e,
                        o.displacement.x *= .992,
                        o.displacement.y *= .992
                    }
                    if (o.pulse > 0) {
                        let e = .96;
                        "komorebi" === o.options.mode && (e = .99),
                        o.pulse *= e,
                        o.pulse < .01 && (o.pulse = 0)
                    }
                    "aurora" === o.options.mode && (o.clickOffset += .08 * (o.clickOffsetTarget - o.clickOffset));
                    const v = .88 + .06 * (a.scrollStrength || .2);
                    o.scrollOffset += o.scrollVelocity,
                    o.scrollVelocity *= v;
                    const p = t.material.uniforms;
                    p.uTime.value = this.time,
                    p.uMouse.value.lerp(o.currentMouse, .1),
                    p.uMouseVelocity?.value.copy(o.mouseVelocity),
                    p.uDisplacement?.value.copy(o.displacement),
                    p.uPulse && (p.uPulse.value = o.pulse),
                    p.uClickOffset && (p.uClickOffset.value = o.clickOffset || 0),
                    p.uLastClickPos && (p.uLastClickPos.value = o.lastClickPos || new THREE.Vector2(.5,.5)),
                    p.uScrollOffset && (p.uScrollOffset.value = o.scrollOffset),
                    p.uScrollVelocity && (p.uScrollVelocity.value = 100 * Math.abs(o.scrollVelocity));
                    const h = o.stacking;
                    (!o.cachedStyle || o.styleCacheTime < e - 500) && (o.cachedStyle = window.getComputedStyle(s),
                    o.styleCacheTime = e);
                    const g = o.cachedStyle;
                    let x, b;
                    if (a.border && a.border.enabled) {
                        const e = a.border.width || 2;
                        x = f.width + 2 * e,
                        b = f.height + 2 * e
                    } else
                        x = f.width,
                        b = f.height;
                    const y = Math.floor(x * this.sharedPixelRatio)
                      , w = Math.floor(b * this.sharedPixelRatio);
                    y === this.lastRenderedWidth && w === this.lastRenderedHeight || (this.sharedRenderer.setSize(x, b),
                    this.lastRenderedWidth = y,
                    this.lastRenderedHeight = w);
                    const C = r.lastWidth !== y || r.lastHeight !== w;
                    if (C && (c.width = y,
                    c.height = w,
                    r.lastWidth = y,
                    r.lastHeight = w),
                    p.uResolution.value.set(y, w),
                    this.sharedRenderer.render(i, l),
                    C && u.clearRect(0, 0, y, w),
                    u.drawImage(this.sharedRenderer.domElement, 0, 0, y, w),
                    c.style.position = h.position,
                    ...
                    "fixed" === h.position)
                        ...
                        c.style.zIndex = String(h.zIndex + 1);
                    else {
                        c.style.top = `${s.offsetTop}px`,
                        c.style.left = `${s.offsetLeft}px`;
                        const e = window.getComputedStyle(s);
                        c.style.zIndex = "auto" === e.zIndex ? "0" : e.zIndex
                    }
                    if (a.border && a.border.enabled) {
                        const e = a.border.width || 2
                          , n = s.parentNode;
                        ...
                        let t = parseFloat(o.borderRadius) || 0;
                        a.border.radius && (t = a.border.radius);
                        const i = t + e;
                        c.style.borderRadius = `${i}px`,
                        ...
                        const l = e
                          ...
                          , d = f.width
                          , m = f.height
                          , v = `url("data:image/svg+xml,${encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="${r}" height="${u}"><path fill-rule="evenodd" fill="white" d="M${i},0 H${r - i} A${i},${i} 0 0 1 ${r},${i} V${u - i} A${i},${i} 0 0 1 ${r - i},${u} H${i} A${i},${i} 0 0 1 0,${u - i} V${i} A${i},${i} 0 0 1 ${i},0 Z M${l + t},${l} A${t},${t} 0 0 0 ${l},${l + t} V${l + m - t} A${t},${t} 0 0 0 ${l + t},${l + m} H${l + d - t} A${t},${t} 0 0 0 ${l + d},${l + m - t} V${l + t} A${t},${t} 0 0 0 ${l + d - t},${l} Z"/></svg>`)}")`;
                        c.style.maskImage = v,
                        c.style.webkitMaskImage = v,
                        c.style.maskSize = "100% 100%",
                        c.style.webkitMaskSize = "100% 100%"
                    } else
                        c.style.borderRadius !== g.borderRadius && (c.style.borderRadius = g.borderRadius),
                        c.style.overflow = "hidden",
        ...
        dispose() {
            ...
            this.sharedRenderer && (this.sharedRenderer.dispose(),
            this.sharedRenderer = null),
            this.effects.clear(),
    ...
    class y {
        constructor(n, t) {
            ...
            this.initialized = !1,
            this.paused = !1,
            this.supported = e.getSupported(),
            this.fallbackApplied = !1,
            this.helperGUI = null
        }
        init() {
            if (!this.initialized) {
                ...
                function() {
                    ...
                    const o = () => {
                        s && clearTimeout(s),
                        s = setTimeout( () => {
                            const o = Math.abs(window.innerWidth - e) > 10
                              , i = Math.abs(window.innerHeight - n) > 100;
                            if (o || i) {
                                for (const [,e] of t)
                                    e && e.initialized && (e.destroy(),
                                    setTimeout( () => e.init(), 50));
                                e = window.innerWidth,
                                n = window.innerHeight
                            }
                        }
                ...
                for (let e = 0; e < this.elements.length; e++) {
                    const o = this.elements[e]
                      , t = o.id || `el-${e}`
                      , i = `${this.id}-${t}`;
                    n.addEffect(i, o, this.options) || (this.fallbackApplied = !0)
                }
                this.initialized = !0,
                t.set(this.id, this),
                this.options.helper && function() {
                    if (d)
                        return Promise.resolve();
                    if (m)
                        return m;
                    return m = new Promise( (e, n) => {
                        if ("undefined" != typeof lil)
                            return d = !0,
                            void e();
                        const o = document.createElement("script");
                        o.src = "https://cdn.jsdelivr.net/npm/lil-gui@0.19.1/dist/lil-gui.umd.min.js",
                        o.integrity = "sha384-2eNPNc7Cms+nVcpmQPotBpthLWCwjAGbkp0Y+3MUQqwPbmTpMFmbh2a230Gkns0x",
                        o.crossOrigin = "anonymous",
                        o.onload = () => {
                            d = !0,
                            function() {
                                if (document.getElementById("spectragl-helper-styles"))
                                    return;
                                const e = document.createElement("style");
                                e.id = "spectragl-helper-styles",
                        ...
                        ,
                        o.onerror = () => {
                            n(new Error("Failed to load lil-gui"))
                        }
                        ,
                    ...
                    const e = f.length;
                    this.helperGUI = function(e, n) {
                        if ("undefined" == typeof lil)
                            return;
                        const o = new lil.GUI({
                            title: `spectraGL Helper ${n + 1}`,
                            closeFolders: !0
                        });
                        o.domElement.classList.add("spectragl-helper"),
                        o.$title.style.cursor = "default";
                        const t = 1 + 3 * n;
                        o.domElement.style.top = `${t}rem`;
                        const i = e.options
                          , l = {
                            color1: i.colors[0] || "#ff6b6b",
                            color2: i.colors[1] || "#4ecdc4",
                            color3: i.colors[2] || "#45b7d1",
                            color4: i.colors[3] || "#f9ca24",
                            color5: i.colors[4] || "#6c5ce7",
                            color6: i.colors[5] || "#00b894",
                            color7: i.colors[6] || "#fd79a8",
                            rimColor: i.rimColor || "#ffffff",
                            colorBlend: i.colorBlend || "smooth",
                            balance1: i.colorBalance[0] || 1,
                            balance2: i.colorBalance[1] || 1,
                            balance3: i.colorBalance[2] || 1,
                            balance4: i.colorBalance[3] || 1,
                            balance5: i.colorBalance[4] || 1,
                            balance6: i.colorBalance[5] || 1,
                            balance7: i.colorBalance[6] || 1
                        }
                          , a = () => {
                            e.updateOptions({
                                colors: [l.color1, l.color2, l.color3, l.color4, l.color5, l.color6, l.color7]
                            })
                        }
                          , s = () => {
                            e.updateOptions({
                                colorBalance: [l.balance1, l.balance2, l.balance3, l.balance4, l.balance5, l.balance6, l.balance7]
                            })
                        }
                          , r = o.addFolder("Colors");
                        r.addColor(l, "color1").name("Color 1").onChange(a),
                        r.addColor(l, "color2").name("Color 2").onChange(a),
                        r.addColor(l, "color3").name("Color 3").onChange(a),
                        r.addColor(l, "color4").name("Color 4").onChange(a),
                        r.addColor(l, "color5").name("Color 5").onChange(a),
                        r.addColor(l, "color6").name("Color 6").onChange(a),
                        r.addColor(l, "color7").name("Color 7").onChange(a),
                        r.addColor(l, "rimColor").name("Rim Color").onChange(n => {
                            e.updateOptions({
                                rimColor: n
                            })
                        }
                        ),
                        r.add(l, "colorBlend", ["smooth", "sharp", "stepped"]).name("Blend Mode").onChange(n => {
                            e.updateOptions({
                                colorBlend: n
                            })
                        }
                        ),
                        r.add(l, "balance1", 0, 2, .1).name("Balance 1").onChange(s),
                        r.add(l, "balance2", 0, 2, .1).name("Balance 2").onChange(s),
                        r.add(l, "balance3", 0, 2, .1).name("Balance 3").onChange(s),
                        r.add(l, "balance4", 0, 2, .1).name("Balance 4").onChange(s),
                        r.add(l, "balance5", 0, 2, .1).name("Balance 5").onChange(s),
                        r.add(l, "balance6", 0, 2, .1).name("Balance 6").onChange(s),
                        r.add(l, "balance7", 0, 2, .1).name("Balance 7").onChange(s);
                        const c = o.addFolder("Animation")
                          , u = {
                            speed: i.speed || 1,
                            foldSpeed: i.foldSpeed || 1,
                            direction: i.direction || "auto"
                        };
                        c.add(u, "speed", 0, 5, .1).name("Speed").onChange(n => {
                            e.updateOptions({
                                speed: n
                            })
                        }
                        ),
                        c.add(u, "foldSpeed", 0, 5, .1).name("Fold Speed").onChange(n => {
                            e.updateOptions({
                                foldSpeed: n
                            })
                        }
                        ),
                        c.add(u, "direction", ["auto", "up", "down", "left", "right"]).name("Direction").onChange(n => {
                            e.updateOptions({
                                direction: n
                            })
                        }
                        );
                        const d = o.addFolder("Geometry")
                          , m = {
                            foldIntensity: i.foldIntensity || .5,
                            foldScale: i.foldScale || 1
                        };
                        d.add(m, "foldIntensity", 0, 2, .05).name("Fold Intensity").onChange(n => {
                            e.updateOptions({
                                foldIntensity: n
                            })
                        }
                        ),
                        d.add(m, "foldScale", 0, 5, .1).name("Fold Scale").onChange(n => {
                            e.updateOptions({
                                foldScale: n
                            })
                        }
                        );
                        const v = o.addFolder("Lighting")
                          , p = {
                            rimLight: void 0 === i.rimLight || i.rimLight,
                            rimIntensity: i.rimIntensity || .8,
                            rimFalloff: i.rimFalloff || 2,
                            grain: i.grain || .05
                        };
                        v.add(p, "rimLight").name("Rim Light").onChange(n => {
                            e.updateOptions({
                                rimLight: n
                            })
                        }
                        ),
                        v.add(p, "rimIntensity", 0, 1, .05).name("Rim Intensity").onChange(n => {
                            e.updateOptions({
                                rimIntensity: n
                            })
                        }
                        ),
                        v.add(p, "rimFalloff", .5, 5, .1).name("Rim Falloff").onChange(n => {
                            e.updateOptions({
                                rimFalloff: n
                            })
                        }
                        ),
                        v.add(p, "grain", 0, .3, .01).name("Grain").onChange(n => {
                            e.updateOptions({
                                grain: n
                            })
                        }
                        );
                        const h = o.addFolder("Interaction")
                          , g = {
                            reactive: void 0 === i.reactive || i.reactive,
                            reactiveStrength: i.reactiveStrength || .3,
                            displacementStrength: i.displacementStrength || .3,
                            mouseRadius: i.mouseRadius || .15,
                            scrollReactive: void 0 !== i.scrollReactive && i.scrollReactive,
                            scrollStrength: i.scrollStrength || .2
                        };
                        h.add(g, "reactive").name("Reactive").onChange(n => {
                            e.updateOptions({
                                reactive: n
                            })
                        }
                        ),
                        h.add(g, "reactiveStrength", 0, 2, .05).name("Reactive Strength").onChange(n => {
                            e.updateOptions({
                                reactiveStrength: n
                            })
                        }
                        ),
                        h.add(g, "displacementStrength", 0, 2, .05).name("Displacement Strength").onChange(n => {
                            e.updateOptions({
                                displacementStrength: n
                            })
                        }
                        ),
                        h.add(g, "mouseRadius", 0, 1, .05).name("Mouse Radius").onChange(n => {
                            e.updateOptions({
                                mouseRadius: n
                            })
                        }
                        ),
                        h.add(g, "scrollReactive").name("Scroll Reactive").onChange(n => {
                            e.updateOptions({
                                scrollReactive: n
                            })
                        }
                        ),
                        h.add(g, "scrollStrength", 0, 2, .05).name("Scroll Strength").onChange(n => {
                            e.updateOptions({
                                scrollStrength: n
                            })
                        }
                        );
                        const x = o.addFolder("Border")
                          , b = {
                            enabled: i.border.enabled || !1,
                            width: i.border.width || 2,
                            radius: i.border.radius || 0
                        };
                        x.add(b, "enabled").name("Enabled").onChange(n => {
                            e.updateOptions({
                                border: {
                                    ...i.border,
                                    enabled: n
                        ...
                        x.add(b, "width", 1, 20, 1).name("Width").onChange(n => {
                            e.updateOptions({
                                border: {
                                    ...i.border,
                                    width: n
                        ...
                        x.add(b, "radius", 0, 50, 1).name("Radius").onChange(n => {
                            e.updateOptions({
                                border: {
                                    ...i.border,
                                    radius: n
                        ...
                        const y = {
                            mode: i.mode || "aurora",
                            meshDetail: i.meshDetail || 32,
                            target: i.target || ".spectraGL"
                        };
                        o.add(y, "mode", ["aurora", "shimmer", "pixel", "komorebi", "nebula", "floral", "oil", "diva"]).name("Mode").onFinishChange(n => {
                            confirm("Changing mode requires reinitialization. Continue?") ? e.updateOptions({
                                mode: n
                            }) : (y.mode = i.mode,
                            o.controllersRecursive().forEach(e => e.updateDisplay()))
                        }
                        ),
                        o.add(y, "meshDetail", 16, 128, 1).name("Mesh Detail").onFinishChange(n => {
                            confirm("Changing mesh detail requires reinitialization. Continue?") ? e.updateOptions({
                                meshDetail: n
                            }) : (y.meshDetail = i.meshDetail,
                            o.controllersRecursive().forEach(e => e.updateDisplay()))
                        }
                        );
                        const w = {
                            qualityPreset: i.qualityPreset || "balanced",
                            pixelRatio: i.pixelRatio || "auto",
                            maxFPS: i.maxFPS || 60
                        };
                        o.add(w, "qualityPreset", ["low", "balanced", "high"]).name("Quality Preset").onChange(n => {
                            e.updateOptions({
                                qualityPreset: n
                            })
                        }
                        ),
                        o.add(w, "pixelRatio", ["auto", "1", "2"]).name("Pixel Ratio").onChange(n => {
                            e.updateOptions({
                                pixelRatio: "auto" === n ? "auto" : parseFloat(n)
                            })
                        }
                        ),
                        o.add(w, "maxFPS", 15, 120, 1).name("Max FPS").onChange(n => {
                            e.updateOptions({
                                maxFPS: n
                            })
                        }
                        ...
                        const C = {
                            copySettings: () => {
                                const n = function(e) {
                                    const n = ["spectraGL({"];
                                    n.push(`  target: "${e.target}",`),
                                    n.push(`  mode: "${e.mode}",`);
                                    const o = e.colors.map(e => `"${e}"`).join(", ");
                                    n.push(`  colors: [${o}],`),
                                    n.push(`  colorBlend: "${e.colorBlend}",`);
                                    const t = e.colorBalance.join(", ");
                                    return n.push(`  colorBalance: [${t}],`),
                                    n.push(`  meshDetail: ${e.meshDetail},`),
                                    n.push(`  foldIntensity: ${e.foldIntensity},`),
                                    n.push(`  foldScale: ${e.foldScale},`),
                                    n.push(`  foldSpeed: ${e.foldSpeed},`),
                                    n.push(`  rimLight: ${e.rimLight},`),
                                    n.push(`  rimIntensity: ${e.rimIntensity},`),
                                    n.push(`  rimColor: "${e.rimColor}",`),
                                    n.push(`  rimFalloff: ${e.rimFalloff},`),
                                    n.push(`  speed: ${e.speed},`),
                                    n.push(`  direction: "${e.direction}",`),
                                    n.push(`  grain: ${e.grain},`),
                                    n.push(`  reactive: ${e.reactive},`),
                                    n.push(`  reactiveStrength: ${e.reactiveStrength},`),
                                    n.push(`  displacementStrength: ${e.displacementStrength},`),
                                    n.push(`  mouseRadius: ${e.mouseRadius},`),
                                    n.push(`  scrollReactive: ${e.scrollReactive},`),
                                    n.push(`  scrollStrength: ${e.scrollStrength},`),
                                    n.push(`  pixelRatio: "${e.pixelRatio}",`),
                                    n.push(`  maxFPS: ${e.maxFPS},`),
                                    n.push(`  qualityPreset: "${e.qualityPreset}",`),
                                    n.push("  border: {"),
                                    n.push(`    enabled: ${e.border.enabled},`),
                                    n.push(`    width: ${e.border.width},`),
                                    n.push(`    radiusFromElement: ${e.border.radiusFromElement},`),
                                    n.push(`    radius: ${e.border.radius},`),
                                    n.push(`    position: "${e.border.position}",`),
                                    n.push("  },"),
                                    n.push("  helper: false,"),
                                    n.push("});"),
                                    n.join("\n")
                                }(e.options)
                                  , t = o.controllers.find(e => "copySettings" === e.property);
                                if (!t)
                                    return;
                                const i = t._name;
                                t.disable(),
                                ...
                                function a(e) {
                                    ...
                                    try {
                                        ...
                                        t.name(i),
                                        t.enable(),
                                        prompt("Copy this code manually:", e)
                                    }
                        ...
                        return o.add(C, "copySettings").name("Copy settings"),
                        r.close(),
                        c.close(),
                        d.close(),
                        v.close(),
                    ...
                    console.error("Failed to load helper GUI:", e)
                }
                ),
                this.options.on && this.options.on.init && this.options.on.init(this)
            }
        }
        destroy() {
            if (this.initialized) {
                this.helperGUI && (!function(e) {
                    const n = f.findIndex(n => n.instance === e);
                    if (-1 !== n) {
                        const {gui: e} = f[n];
                        e.destroy(),
                        f.splice(n, 1),
                        f.forEach( (e, n) => {
                            const o = 1 + 3 * n;
                            e.gui.domElement.style.top = `${o}rem`
                        }
                        )
                    }
                }(this),
                this.helperGUI = null);
                for (let e = 0; e < this.elements.length; e++) {
                    const o = this.elements[e].id || `el-${e}`
                      , t = `${this.id}-${o}`;
                    n.removeEffect(t)
                }
                t.delete(this.id),
                0 === t.size && n && (n.dispose(),
                n = null,
                function() {
                    a && (window.removeEventListener("resize", a.handleResize),
                    a = null);
                    s && (clearTimeout(s),
                    s = null)
                }()),
                this.initialized = !1,
                this.options.on && this.options.on.destroy && this.options.on.destroy(this)
            }
        }
        pause() {
            this.paused = !0
        ...
        updateOptions(e) {
            const o = e || {}
              , t = void 0 !== o.field || void 0 !== o.fieldOctaves || void 0 !== o.fieldLacunarity || void 0 !== o.fieldGain || void 0 !== o.fieldAmplitude || void 0 !== o.fieldWarpStrength || void 0 !== o.fieldSeed || void 0 !== o.fieldFlow || void 0 !== o.fieldAngle || void 0 !== o.fieldNoiseType || void 0 !== o.fieldFractalType || void 0 !== o.fieldBoxFreq || void 0 !== o.fieldDebug;
            t && (e = {
                ...e,
                field: normalizeFieldOptions(o, this.options.field || {})
            });
            const n = {
                ...this.options
            };
            ...
            ["target", "mode", "meshDetail"].some(o => void 0 !== e[o] && e[o] !== n[o]) ? (this.destroy(),
            setTimeout( () => this.init(), 50)) : this.updateLiveUniforms(e)
        }
        updateLiveUniforms(e) {
            if (n)
                for (let o = 0; o < this.elements.length; o++) {
                    const t = this.elements[o].id || `el-${o}`
                      , i = `${this.id}-${t}`
                      , l = n.effects.get(i);
                    if (l && l.mesh.material.uniforms) {
                        const n = l.mesh.material.uniforms;
                        if (void 0 !== e.speed && (n.uSpeed.value = e.speed),
                        void 0 !== e.foldIntensity && (n.uFoldIntensity.value = e.foldIntensity),
                        void 0 !== e.foldScale && (n.uFoldScale.value = e.foldScale),
                        void 0 !== e.foldSpeed && (n.uFoldSpeed.value = e.foldSpeed),
                        void 0 !== e.rimIntensity && (n.uRimIntensity.value = e.rimIntensity),
                        void 0 !== e.rimColor && n.uRimColor.value && n.uRimColor.value.set(e.rimColor),
                        void 0 !== e.rimFalloff && (n.uRimFalloff.value = e.rimFalloff),
                        void 0 !== e.grain && (n.uGrain.value = e.grain),
                        void 0 !== e.reactiveStrength && (n.uReactiveStrength.value = e.reactiveStrength),
                        void 0 !== e.displacementStrength && (l.options.displacementStrength = e.displacementStrength),
                        void 0 !== e.mouseRadius && (n.uMouseRadius.value = e.mouseRadius),
                        (void 0 !== e.field || void 0 !== e.fieldOctaves || void 0 !== e.fieldLacunarity || void 0 !== e.fieldGain || void 0 !== e.fieldAmplitude || void 0 !== e.fieldWarpStrength || void 0 !== e.fieldSeed || void 0 !== e.fieldFlow || void 0 !== e.fieldAngle || void 0 !== e.fieldNoiseType || void 0 !== e.fieldFractalType || void 0 !== e.fieldBoxFreq || void 0 !== e.fieldDebug) && n.uFieldOctaves && (l.options.field = normalizeFieldOptions(e, l.options.field || {}),
                        n.uFieldOctaves.value = l.options.field.octaves,
                        n.uFieldLacunarity.value = l.options.field.lacunarity,
                        n.uFieldGain.value = l.options.field.gain,
                        n.uFieldAmplitude.value = l.options.field.amplitude,
                        n.uFieldWarpStrength.value = l.options.field.warpStrength,
                        n.uFieldSeed.value && n.uFieldSeed.value.set(l.options.field.seed[0], l.options.field.seed[1]),
                        n.uFieldFlow.value && n.uFieldFlow.value.set(l.options.field.flow[0], l.options.field.flow[1]),
                        n.uFieldAngle.value = l.options.field.angle,
                        n.uFieldNoiseType && (n.uFieldNoiseType.value = fieldNoiseTypeToInt(l.options.field.noiseType)),
                        n.uFieldFractalType && (n.uFieldFractalType.value = fieldFractalTypeToInt(l.options.field.fractalType)),
                        n.uFieldBoxFreq && (n.uFieldBoxFreq.value = l.options.field.boxFreq),
                        n.uFieldDebug && (n.uFieldDebug.value = l.options.field.debug),
                        n.uFieldMin && (n.uFieldMin.value = l.options.field.min),
                        n.uFieldMax && (n.uFieldMax.value = l.options.field.max)),
                        void 0 !== e.colors && n.uColors.value) {
                            const o = e.colors
                              , t = n.uColors.value;
                            for (let e = 0; e < 7; e++)
                                if (t[e]) {
                                    const n = void 0 !== o[e] ? o[e] : o.length > 0 ? o[o.length - 1] : "#ffffff";
                                    t[e].set(n)
                                }
                        }
                        if (void 0 !== e.colorBlend) {
                            const o = {
                                smooth: 0,
                                sharp: 1,
                                stepped: 2
                            };
                            n.uColorBlend.value = o[e.colorBlend] || 0
                        }
                        if (void 0 !== e.colorBalance) {
                            const o = e.colorBalance || []
                              , t = [];
                            for (let e = 0; e < 7; e++)
                                t.push(void 0 !== o[e] ? o[e] : 1);
                            n.uColorBalance.value = t
                        }
                        if (void 0 !== e.direction) {
                            const o = {
                                auto: 0,
                                up: 1,
                                down: 2,
                            ...
                            n.uDirection.value = o[e.direction] || 0
                        }
                        void 0 !== e.rimLight && (n.uRimLight.value = e.rimLight ? 1 : 0),
                        l.options = {
                            ...l.options,
                            ...e
                        }
    ...
    window.spectraGL = function(e={}) {
        const n = {
            target: ".spectraGL",
            mode: "aurora",
            colors: ["#ff6b6b", "#4ecdc4", "#45b7d1", "#f9ca24", "#6c5ce7", "#00b894", "#fd79a8"],
            colorBlend: "smooth",
        ...
        o.field = normalizeFieldOptions(e, n.field);
        if (!e.qualityPreset && function() {
            const e = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)
              ...
              , o = navigator.deviceMemory || 4;
            return e || n <= 2 || o <= 2 || v()
        }() && (o.qualityPreset = "low"),
        o.qualityPreset && !e.meshDetail) {
            const n = {
                low: {
                    meshDetail: 16,
                    maxFPS: 30
            ...
            e.maxFPS || (o.maxFPS = n.maxFPS))
        }
        let t = o.maxFPS || 60;
        if (v() && !e.maxFPS) {
            const e = ["nebula", "oil", "floral"];
            Array.from(document.querySelectorAll(o.target)).some(n => {
                const t = o.mode || "aurora";
                return e.includes(t)
            }
            ) && (t = 30)
        }
        c = 1e3 / t;
        const i = document.querySelectorAll(o.target);
        if (0 === i.length)
            return console.error(`spectraGL: No elements found for "${o.target}"`),
            null;
        const l = new y(o,Array.from(i));
        return l.init(),
        {
            pause: () => l.pause(),
            play: () => l.play(),
            destroy: () => l.destroy(),
            updateOptions: e => l.updateOptions(e),
            get isPlaying() {
                return !l.paused
            },
            get options() {
            ...
            get fallbackApplied() {
                return l.fallbackApplied
            }
        }
    }
    ,
    window.spectraGL.isSupported = () => e.getSupported(),
